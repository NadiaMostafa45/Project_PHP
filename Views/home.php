        ...
        <div class="col-lg-4">
            <div class="cart-panel shadow-lg">
              ...
              <<form action="../routes/process_order.php" method="POST">
                    ...
                    <div class="mt-3">
                        <label class="small fw-bold mb-2 opacity-75">Deliver to</label>
                        <select name="room_no" class="form-select custom-input" required>
                            <option value="" disabled selected>Select Room</option>
                            <option value="2010">Room 2010</option>
                            <option value="2011">Room 2011</option>
                            <option value="2012">Room 2012</option>
                        </select>
                    </div>
