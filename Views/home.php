...
<head>
    ...
    <style>
        ...
        .navbar-brand { font-family: 'Playfair Display', serif; font-weight: 900; color: var(--espresso) !important; font-size: 1.6rem; }

        .section-title { font-family: 'Playfair Display', serif; font-weight: 900; font-size: 2.5rem; margin-bottom: 5px; }
        ...
        .qty-box a { color: var(--espresso); text-decoration: none; font-weight: 900; }
        ...
        .room-dropdown:hover { background-color: white !important; box-shadow: 0 5px 15px rgba(0,0,0,0.1); }
        ...
        .room-options.show { display: block; animation: slideDown 0.3s ease; }
        ...
        .order-now-btn:hover { background: white; transform: translateY(-2px); }
    </style>
</head>
<body>
