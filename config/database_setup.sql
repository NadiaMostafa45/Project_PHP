...
INSERT INTO users (name, email, password, role, ext, image) VALUES
('Admin User', 'admin@gmail.com', '$2y$10$hqVb./Befmf3GSiVrIMAw.x9vYI.0CHhB.hDm//XACJyef7j2w91u', 'admin', NULL, NULL),
('Normal User', 'user@gmail.com', '$2y$10$hqVb./Befmf3GSiVrIMAw.x9vYI.0CHhB.hDm//XACJyef7j2w91u', 'user', NULL, NULL)
